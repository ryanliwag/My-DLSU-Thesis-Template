...
\newcommand{\examinerChair}{Aaron Don Africa}

% Sort in alphabetically ascending manner the surnames of the examiners
\newcommand{\examinerATitle}{Dr.} 
\newcommand{\examinerA}{Roderick Yap}

\newcommand{\examinerBTitle}{Dr.} 
\newcommand{\examinerB}{Edwin Sybingco}

% Note that \examinerC and \examinerD only applies for PhD dissertations
\newcommand{\examinerCTitle}{Dr.} 
\newcommand{\examinerC}{Jay Robert Del Rosario}

\newcommand{\examinerDTitle}{Dr.} 
\newcommand{\examinerD}{Donabel de Veas-Abuan}

\newcommand{\deanTitle}{Dr.} 
\newcommand{\deanName}{Cesar Llorente}

\newcommand{\groupID}{Anfernee and Friends} % group ID number is for undergraduates as of this formatting
...
\defineAuthor{surname1}{Cepria}
\defineAuthor{firstname1}{Kevin Jeff T.}

\defineAuthor{surname2}{Eco}
\defineAuthor{firstname2}{Lance Randall L.}
...
\newcommand{\documentTitle}{Development of a Remote Controlled Bluetooth Mobile Bot with Live Video Feedback} % put tilde (~) between words to indicate non-breaking adjacent words

\newcommand{\keywords}{bluetooth, arduino, android}

\newcommand{\approvalDate}{May~29,~\the\year} % put here the date when all examiners and/or their approved representative have given their approval; do not remove the tildes in order to not break the date; the submission deadline can also be placed as the date
